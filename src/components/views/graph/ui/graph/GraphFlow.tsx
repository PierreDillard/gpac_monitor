    ...
    <div style={flowStyles} className={isResizing ? 'resize-optimized' : ''}>
      ...
      >
        ...
        <MiniMap
          ...
          className="bg-gray-900 border border-gray-900 rounded-md w-52 h-36 [&_.react-flow\_\_minimap-svg]:cursor-grab [&_.react-flow\_\_minimap-svg:active]:cursor-grabbing"
          style={minimapStyle}
